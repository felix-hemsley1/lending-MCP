...
const DISCLAIMER =
  "DEMO / ILLUSTRATIVE ONLY — THIS IS FAKE DATA. The iwoca Credit Compass shown " +
  "here is not a credit score, not a credit decision, and not an indication of what " +
  "iwoca would offer. The score, band, and factors are generated by placeholder demo " +
  "logic on the inputs you provided and use no real iwoca scoring or credit data. " +
  "Producing a genuine Credit Compass would require connecting to iwoca's scoring API, " +
  "which is not connected in this demo.";

export const creditCompassDefinition = {
  name: "credit_compass",
  title: "iwoca Credit Compass (demo)",
  description:
    "Show the iwoca Credit Compass — a DEMO using FAKE data, not a real credit score " +
    "or decision and using no real iwoca data. A genuine Credit Compass would require " +
    "connecting to iwoca's scoring API, which is not connected here. All inputs are " +
    "optional; it returns an illustrative score (35–90), a band, three factors, and a " +
    "disclaimer. Always present this as fake demo data, never as a credit outcome.",
  annotations: {
    readOnlyHint: true,
    openWorldHint: false,
  },
